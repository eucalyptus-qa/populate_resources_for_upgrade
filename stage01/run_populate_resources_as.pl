...
print "\n";
print "########################### ADJUST POPULATE_RESOURCES_AS_USER ##############################\n";

my $from = "account00";
my $to = $account_name;
my $file = "./populate_resources_as_user/populate_resources_as_user.conf";
...
print "\n";
print "########################### RUN POPULATE_RESOURCES_AS_USER ##############################\n";

my $cmd = "cp ../input/2b_tested.lst ./populate_resources_as_user/input/.";
system($cmd);

$cmd = "cd ./populate_resources_as_user; ./run_test.pl populate_resources_as_user.conf";
system($cmd);
...
print "\n";
print "[TEST_REPORT]\tPOPULATE_RESOURCES_AS HAS BEEN COMPLETED\n";
print "\n";
